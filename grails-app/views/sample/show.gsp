...
<body>
	<div id="show-sample"
		...
		<g:form class="form-horizontal">
				...
				<g:if test="${sampleInstance?.sampleInPlate}">
				
				<div class="control-group">

					<label id="sampleInPlate-label" class="control-label"><g:message code="sample.sampleInPlate.label" default="Sample In Plate" /></label>
					
					<div class="controls">
					
						<g:each in="${sampleInstance.sampleInPlate}" var="s">
