...
<body>
	<div id="list-plateType" class="content span8 scaffold-list" role="main">
		<h1>
		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				<g:each in="${plateTypeInstanceList}" status="i" var="plateTypeInstance">
					<tr>

						<td>
							<g:link action="show" id="${plateTypeInstance.id}">
								${fieldValue(bean: plateTypeInstance, field: "name")}
							</g:link>
						</td>

						<td>
							${fieldValue(bean: plateTypeInstance, field: "row")}
						</td>

						<td>
							${fieldValue(bean: plateTypeInstance, field: "col")}
						</td>
